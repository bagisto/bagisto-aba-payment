            ...
            <div class="order-description row fs16 cart-details">
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="payment mb20">
                        ...
                        <div class="mb-4">
                            @if (core()->getConfigData('sales.paymentmethods.' . $cart->payment->method . '.title') == 'ABA Pay') 
                                <img src="{{asset('themes/default/assets/images/aba-pay.png')}}" style="height: 39px;
                                margin-left: 7px;">
                                    
                            @endif

                            @if (core()->getConfigData('sales.paymentmethods.' . $cart->payment->method . '.title') == 'Credit/Debit Card') 
